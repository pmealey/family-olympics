...
import { handler } from '../../../lib/lambda/scores/delete';
...
describe('Scores Delete Handler', () => {
  ...
  it('should delete an existing score', async () => {
    ...
    const event = {
      pathParameters: { year: '2025', eventId: 'event-1', scoreId: 'score-1' },
  ...
  it('should return 404 if score not found', async () => {
    ...
    const event = {
      pathParameters: { year: '2025', eventId: 'event-1', scoreId: 'non-existent' },
    } as Partial<APIGatewayProxyEvent> as APIGatewayProxyEvent;
